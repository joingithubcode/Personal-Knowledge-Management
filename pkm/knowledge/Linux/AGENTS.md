...
folder. This folder holds durable knowledge about Linux.

## Folder Mission

Store self-contained, long-lived notes about Linux concepts, tooling, and
internals, independent of any specific distribution.

## Responsibilities

- Maintain atomic notes for Linux topics.
...
- No distribution-specific or vendor-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material useful across Linux systems.
...
- Including distribution-specific or vendor-specific detail.
