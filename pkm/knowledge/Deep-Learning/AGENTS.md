# AGENTS.md — Deep-Learning

Working rules for humans, editors, and AI agents working in this category
folder. This folder holds durable knowledge about deep learning.

## Folder Mission

Store self-contained, long-lived notes about neural networks, training,
and representation learning, independent of any specific framework.

## Responsibilities

- Maintain atomic notes for deep learning topics.
...
- No framework-specific or vendor-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material useful beyond a specific model release.
...
- Including framework-specific or vendor-specific detail.
