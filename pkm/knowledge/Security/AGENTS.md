...
folder. This folder holds durable knowledge about security.

## Folder Mission

Store self-contained, long-lived notes about security principles,
threats, and defenses, independent of any specific tool or incident.

## Responsibilities

- Maintain atomic notes for security topics.
...
- No incident-specific or vendor-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material general enough to remain relevant.
...
- Including incident-specific or vendor-specific detail.
