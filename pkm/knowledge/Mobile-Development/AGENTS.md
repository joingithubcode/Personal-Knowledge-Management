# AGENTS.md — Mobile-Development

Working rules for humans, editors, and AI agents working in this category
folder. This folder holds durable knowledge about mobile development.

## Folder Mission

Store self-contained, long-lived notes about mobile platforms and
practice, independent of any specific device ecosystem.

## Responsibilities

- Maintain atomic notes for mobile development topics.
...
- No platform-specific or vendor-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material useful across mobile ecosystems.
...
- Including platform-specific or vendor-specific detail.
