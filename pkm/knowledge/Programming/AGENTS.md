# AGENTS.md — Programming

Working rules for humans, editors, and AI agents working in this category
folder. This folder holds durable knowledge about the craft of writing
code.

## Folder Mission

Store self-contained, long-lived notes about programming languages,
paradigms, idioms, and practices, independent of any tool or project.
...
- Keep material tool independent and timeless.
