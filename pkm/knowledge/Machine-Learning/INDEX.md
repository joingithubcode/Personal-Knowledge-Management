...
Registry and organizational plan for the Machine-Learning category in the knowledge
section.

## Category purpose

Durable knowledge about teaching machines to learn from data.

## Scope

Learning paradigms, model families, evaluation, and practice.
