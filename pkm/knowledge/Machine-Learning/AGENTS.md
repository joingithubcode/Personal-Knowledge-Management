# AGENTS.md — Machine-Learning

Working rules for humans, editors, and AI agents working in this category
folder. This folder holds durable knowledge about machine learning.

## Folder Mission

Store self-contained, long-lived notes about machine learning concepts,
model families, and practice, independent of any specific library.

## Responsibilities

- Maintain atomic notes for machine learning topics.
...
- No library-specific or vendor-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material useful beyond a single dataset or tool.
...
- Including library-specific or vendor-specific detail.
