# AGENTS.md — Artificial-Intelligence

Working rules for humans, editors, and AI agents working in this category
folder. This folder holds durable knowledge about the field of artificial
intelligence.

## Folder Mission

Store self-contained, long-lived notes about AI concepts, methods, and
applications, independent of any specific model or vendor.

## Responsibilities

- Maintain atomic notes for AI topics.
...
- No model-specific or vendor-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material useful as the field evolves.
...
- Including tool-specific or vendor-specific detail.
