# AGENTS.md — Algorithms

Working rules for humans, editors, and AI agents working in this category
folder. This folder holds durable knowledge about algorithms.

## Folder Mission

Store self-contained, long-lived notes about algorithms and
problem-solving, independent of any specific language.

## Responsibilities

- Maintain atomic notes for algorithm topics.
