...
folder. This folder holds durable knowledge about databases.

## Folder Mission

Store self-contained, long-lived notes about data storage, data models,
and querying, independent of any specific database engine.

## Responsibilities

- Maintain atomic notes for database topics.
...
- No engine-specific or vendor-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material useful across database systems.
...
- Including engine-specific or vendor-specific detail.
