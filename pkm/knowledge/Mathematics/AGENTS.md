# AGENTS.md — Mathematics

Working rules for humans, editors, and AI agents working in this category
folder. This folder holds durable knowledge about mathematics.

## Folder Mission

Store self-contained, long-lived notes about mathematical concepts and
methods, useful across computing and reasoning.

## Responsibilities

- Maintain atomic notes for mathematical topics.
...
- No application-specific or tool-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material general and foundational.
...
- Including application-specific or tool-specific detail.
