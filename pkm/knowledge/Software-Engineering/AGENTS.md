# AGENTS.md — Software-Engineering

Working rules for humans, editors, and AI agents working in this category
folder. This folder holds durable knowledge about the discipline of
building and maintaining software.

## Folder Mission

Store self-contained, long-lived notes about engineering practice,
process, quality, and architecture, independent of any single project.

## Responsibilities

- Maintain atomic notes for engineering topics.
...
- No project-specific or vendor-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material independent of any employer or tool.
