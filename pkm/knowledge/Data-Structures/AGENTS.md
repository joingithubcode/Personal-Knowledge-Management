# AGENTS.md — Data-Structures

Working rules for humans, editors, and AI agents working in this category
folder. This folder holds durable knowledge about data structures.

## Folder Mission

Store self-contained, long-lived notes about data structures and their
trade-offs, independent of any specific language.

## Responsibilities

- Maintain atomic notes for data structure topics.
...
- No language-specific or platform-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material timeless and theory-focused.
...
- Including language-specific or platform-specific detail.
