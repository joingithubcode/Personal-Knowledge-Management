# AGENTS.md — Productivity

Working rules for humans, editors, and AI agents working in this category
folder. This folder holds durable knowledge about productivity.

## Folder Mission

Store self-contained, long-lived notes about focus, workflow, and
organization, independent of any specific tool.

## Responsibilities

- Maintain atomic notes for productivity topics.
...
- No tool-specific or vendor-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material useful across tools and seasons.
