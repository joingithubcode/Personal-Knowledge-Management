...
folder. This folder holds durable knowledge about cloud computing.

## Folder Mission

Store self-contained, long-lived notes about cloud concepts, services,
and patterns, independent of any specific cloud provider.

## Responsibilities

- Maintain atomic notes for cloud topics.
...
- No provider-specific or vendor-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material useful across cloud platforms.
...
- Including provider-specific or vendor-specific detail.
