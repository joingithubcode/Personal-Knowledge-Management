...
folder. This folder holds durable knowledge about computer networks.

## Folder Mission

Store self-contained, long-lived notes about networking concepts and
protocols, independent of any specific vendor or technology.

## Responsibilities

- Maintain atomic notes for networking topics.
...
- No vendor-specific or product-specific content.
- Do not duplicate concepts across notes or categories.
- Keep material useful across network technologies.
...
- Including vendor-specific or product-specific detail.
