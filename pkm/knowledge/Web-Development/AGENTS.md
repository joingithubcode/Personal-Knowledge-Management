# AGENTS.md — Web-Development

Working rules for humans, editors, and AI agents working in this category
folder. This folder holds durable knowledge about web development.

## Folder Mission

Store self-contained, long-lived notes about web standards, architecture,
and practice, independent of any specific framework.

## Responsibilities

- Maintain atomic notes for web development topics.
...
- Keep material useful as frameworks evolve.
