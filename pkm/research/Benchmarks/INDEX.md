...
Registry and organizational plan for the Benchmarks category in the research
section.

## Category purpose

Working notes about evaluation tasks and scoring standards.

## Scope

Task definitions, data, metrics, and known caveats.
