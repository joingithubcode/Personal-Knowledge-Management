...
folder. This folder holds general working research notes.

## Folder Mission

Store self-contained, durable working notes that hold research thinking
until it settles into a more specific category.
...
- Notes are working material, not final results.
- No raw sources or unprocessed data.
- Do not duplicate threads across multiple notes.
- Do not let notes pretend to be finished knowledge.
...
- Link notes to related research categories.
...
- Promote settled threads to their proper category.
...
- Merge duplicate thread notes into one.

## Common Mistakes

- Treating working notes as final knowledge.
- Storing raw sources or unprocessed data.
