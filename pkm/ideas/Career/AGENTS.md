...
folder. This folder holds ideas about professional direction.

## Folder Mission

Capture and organize career ideas early, keeping professional concepts
intact until they are considered or dropped.

## Responsibilities

- Maintain one atomic note per career idea.
...
- Ideas only; no plans or applications here.
- No tasks, schedules, or job detail.
- Do not duplicate an idea that already exists.
- Do not store finished career knowledge here.
