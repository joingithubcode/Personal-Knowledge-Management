...
folder. This folder holds ideas about software and tools.

## Folder Mission

Capture and organize software ideas early, keeping technical concepts
intact until they are explored or dropped.

## Responsibilities

- Maintain one atomic note per software idea.
...
- Ideas only; no design or architecture here.
- No tasks, schedules, or execution detail.
- Do not duplicate an idea that already exists.
- Do not store finished technical knowledge here.
