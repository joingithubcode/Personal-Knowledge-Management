...
folder. This folder holds ideas about learning and skills.

## Folder Mission

Capture and organize learning ideas early, keeping study goals and skill
concepts intact until they are pursued or dropped.

## Responsibilities

- Maintain one atomic note per learning idea.
- Record the goal and why it matters briefly.
...
- Route pursued ideas to research or knowledge.

## Boundaries

- Ideas only; no study plans or schedules here.
- No tasks, tracking, or course detail.
- Do not duplicate an idea that already exists.
- Do not store finished learning knowledge here.
...
- Move pursued ideas to research or knowledge.
