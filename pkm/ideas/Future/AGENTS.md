...
folder. This folder holds forward-looking ideas.

## Folder Mission

Capture and organize long-horizon ideas, keeping future possibilities
intact until the right time to act.

## Responsibilities

- Maintain one atomic note per future idea.
- Record the vision and why it matters briefly.
...
- Route timely ideas to their proper category.

## Boundaries

- Ideas only; no plans or forecasts here.
- No tasks, schedules, or commitment detail.
- Do not duplicate an idea that already exists.
- Do not store finished future knowledge here.
...
- Move timely ideas to their proper category.
