...
folder. This folder holds ideas about creating content.

## Folder Mission

Capture and organize content ideas early, keeping writing and media
concepts intact until they are developed or dropped.

## Responsibilities

- Maintain one atomic note per content idea.
...
- Ideas only; no drafts or outlines here.
- No tasks, schedules, or publishing detail.
- Do not duplicate an idea that already exists.
- Do not store finished content knowledge here.
