...
folder. This folder holds ideas about business and ventures.

## Folder Mission

Capture and organize business ideas early, keeping them intact and
retrievable until they are developed or dropped.

## Responsibilities

- Maintain one atomic note per business idea.
- Record the idea and why it matters briefly.
...
- Ideas only; no business plans or analysis here.
- No tasks, schedules, or execution detail.
- Do not duplicate an idea that already exists.
- Do not store finished business knowledge here.
...
- Move developed ideas to projects or research.
