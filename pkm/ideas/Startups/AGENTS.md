...
folder. This folder holds ideas about new ventures.

## Folder Mission

Capture and organize startup ideas early, keeping founder-level
opportunities intact until they are assessed or dropped.

## Responsibilities

- Maintain one atomic note per startup idea.
...
- Ideas only; no business plans or models here.
- No tasks, schedules, or execution detail.
- Do not duplicate an idea that already exists.
- Do not store finished venture knowledge here.
